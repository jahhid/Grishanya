...
//let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;Жека Воробей 👑;;;\nFN:Жека Воробей 👑\nORG:Жека Воробей👑\nTITLE:\nitem1.TEL;waid=+79773452127:\nitem1.X-ABLabel:Жека Воробей👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:Жека Воробей 👑\nEND:VCARD`
//await conn.sendMessage(m.chat, { contacts: { displayName: 'Жека Воробей 👑', contacts: [{ vcard }] }}, {quoted: m})
