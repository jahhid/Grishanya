...
if (!code) throw '*[ ⚠️ ВНИМАНИЕ ⚠️ ] НЕПРАВИЛЬНАЯ ИЛИ ОТСУТСТВУЮЩАЯ ССЫЛКА*\n*👉🏻 ПЕРЕЙДИТЕ ПО ССЫЛКЕ НА ГРУППУ*\n\n*ПРИМЕР:*\n*#join https://chat.whatsapp.com*\n\n*[❗ИНФО❗] НЕ ОТВЕЧАЙТЕ НА СООБЩЕНИЯ, ЭТО МОЖЕТ ПРИЧИНИТЬ ПОМЕХИ, ТОЛЬКО ПИШИТЕ ЕГО КАК НОВОЕ СООБЩЕНИЕ*'
...
handler.command = /^перейти|nuevogrupo$/i
