...
let str = `
*ミ💖 ПРИВЕТ✨${taguser}✨, ЗДЕСЬ ВСЕ КОМАНДЫ БОТА ГришаняА 💖彡*
...
° ඬ⃟🎖️ _${usedPrefix}★Гришаня - 𝙱𝚘𝚝★*<текст>*_
...
let str = `
*ミ💖 Здравствуйте ✨${name}✨, ЗДЕСЬ ВСЕ КОМАНДЫ БОТА Grishanya 💖彡*
