...
conn.sendButton(m.chat, `_${command}_`.trim(), author, haha.data, [['🔄 СЛЕДУЩИЙ 🔄', `/${command}`]], m)}
if (command == 'аниме3') {
...
let json = res.data
let url = json.url
conn.sendButton(m.chat, `_${command}_`.trim(), author, url, [['🔄 СЛЕДУЩИЙ 🔄', `/${command}`]], m)}
if (command == 'жопа') {
...
handler.help = ['девушка3', 'девушка4', 'девушка5', 'девушка6', 'аниме', 'аниме2', 'аниме3', 'аниме4', 'аниме5', 'аниме6', 'аниме7', 'аниме8', 'аниме9', 'аниме10', 'член', 'порно', 'сиськи', 'лесбиянки', 'жопа', ]
handler.command = ['девушка3', 'девушка4', 'девушка5', 'девушка6', 'аниме', 'аниме2', 'аниме3', 'аниме4',  'аниме5', 'аниме6', 'аниме7', 'аниме8', 'аниме9', 'аниме10', 'член', 'порно', 'сиськи', 'лесбиянки', 'жопа', ]
